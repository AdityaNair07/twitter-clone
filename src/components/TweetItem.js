      ...
      <article className="flex space-x-3 border-b border-b-gray px-4 py-3">
        ...
        <div className="flex-1">
          <div className="flex gap-x-1 items-center">
            ...
            <div>
              <span className="text-tw text-[14px]">
                {/* {timeTweet?.toDate().toLocaleTimeString("tr-TR")} */}
                {/* {timeTweet} */}
                time
              </span>
            </div>
          ...
          {Image && (
            <img src={Image} className="max-h-96 rounded-xl mt-3" alt="post" />
          )}
          <ul className="text-tw mt-2 flex justify-between mx-8 -ml-2">
            <div className="flex items-center group gap-x-[6px]">
              ...
              <span className="text-xs !bg-white group-hover:text-primary transition-all">
                1.238
              </span>
            </div>
            <div className="flex items-center group gap-x-[6px]">
              ...
              <span className="text-xs !bg-white group-hover:text-g transition-all">
                1.238
              </span>
            </div>
            <div className="flex items-center group gap-x-[6px]">
              ...
              <span className="text-xs !bg-white group-hover:text-r transition-all">
                1.238
              </span>
            </div>
            <div className="flex items-center group gap-x-[6px]">
